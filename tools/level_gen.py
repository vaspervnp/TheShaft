...
def main(asm_path, build_dir):
    ...
    # The PIXEL data (tileset, font, pen table, palettes, menu map)
    # goes to its own file: main.asm assembles it at org #A600 but
    # PLACES it at #4000 in the load image -- it rides the binary's
    # screen-buffer-B padding into RAM and start: copies it home above
    # the AMSDOS work area, so the code bank stays lean.
    hi_path = asm_path.replace("levels.asm", "levels_hi.asm")
    with open(hi_path, "w") as out:
        w = out.write
        w("; ======================================================================\n")
        w("; GENERATED by tools/level_gen.py -- DO NOT EDIT, edit the tool instead\n")
        w("; Pixel data for the #A600 shelf (see main.asm's hidata block).\n")
        w("; ======================================================================\n\n")
    ...
    with open(asm_path, "w") as out:
        ...
        w("; ======================================================================\n")
        w("; GENERATED by tools/level_gen.py -- DO NOT EDIT, edit the tool instead\n")
        w("; (the pixel data lives in levels_hi.asm, on the #A600 shelf)\n")
        w("; ======================================================================\n\n")
        w("; --- level_table: per level: bank byte (#C4+n), word offset\n")
